...
const MappedProduct = forwardRef<HTMLDivElement, ProductProps>(
    ({ outterDiv, innerDiv, width, shoeItem, setShowOverlay, footer }, ref) => {
        ...
        const currentShoesArray = shoeArray.slice(indexOfFirstShoePage, indexOfLastShoePage)
        ...
        return (
            <>
                ...
                {footer !== 'footer' && <div className='pagination-container'>
                    <button
                        onClick={() => setCurrentShoePage(currentShoePage - 1)}
                    ...
                    <button
                        onClick={() => setCurrentShoePage(currentShoePage + 1)}
                        disabled={currentShoePage === Math.ceil(shoeArray.length / shoePostPerPage)}
                        className='product-navigation'
                    >
                        Next
